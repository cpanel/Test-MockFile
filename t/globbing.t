...
is( [ glob('/*.txt') ], $tests[0][0], 'glob(' . $tests[0][1] . ')', );

is( [</*.txt>], $tests[0][0], '<' . $tests[0][1] . '>', );

is( [ glob('/*.{txt,jp{g}}') ], $tests[1][0], 'glob(' . $tests[1][1] . ')', );

is( [</*.{txt,jp{g}}>], $tests[1][0], '<' . $tests[1][1] . '>', );
...
is( [ glob('/*.txt /*.jpg') ], $tests[2][0], 'glob(' . $tests[2][1] . ')', );
